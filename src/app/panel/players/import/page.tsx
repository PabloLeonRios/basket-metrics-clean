 ...
 * ============================
 * PÁGINA: Players / Importación
 *
 * Objetivo actual:
 * - Esta página funciona como contenedor visual del flujo de importación.
 * - NO contiene lógica de negocio.
 * - Toda la lógica real de importación/exportación sigue delegada
 *   en <PlayerImportManager />.
 *
 ...
 * - si más adelante se necesita validar plantilla desde backend,
 *   preview server-side o colas de importación,
 *   esta página puede seguir siendo un wrapper limpio.
 *
 * Por ahora:
 * - mantener separación entre layout y lógica
 * - no tocar desde acá la lógica funcional del import manager
 *
 * Mejora UI 2026:
 * - hero premium consistente con Players
 * - navegación clara entre los 3 flujos
 * - foco visual en carga masiva / exportación
 */
            ...
            <div className="relative z-10 grid gap-5 xl:grid-cols-[1.3fr_0.7fr] xl:items-end">
              <div className="max-w-3xl">
                ...
                <p className="mt-3 max-w-2xl text-sm leading-7 text-white/50 md:text-[15px]">
                  Cargá jugadores en lote mediante plantilla y mantené el roster
                  actualizado con un flujo más rápido, ordenado y preparado para
                  operación real.
                </p>
              </div>
          ...
          <div className="mb-4 flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
            <div>
              ...
              <p className="mt-2 text-sm text-white/40">
                Descargá la plantilla, importá jugadores y exportá la base
                actual del plantel.
              </p>
            </div>
